...
export const categoriesList = [
  { category: "graphics-design", name: "Graphics & Design" },
  { category: "digital-marketing", name: "Digital Marketing" },
  { category: "writing-translation", name: "Writing & Translation" },
  { category: "video-animation", name: "Video & Animation" },
  { category: "music-audio", name: "Music & Audio" },
  { category: "programming-tech", name: "Programming & Tech" },
  { category: "ai-services", name: "AI Services" },
  { category: "ai-artists", name: "AI Artists" },
  { category: "logo-design", name: "Logo Design" },
  { category: "social-media", name: "Social Media" },
  { category: "video-explainer", name: "Video Explainer" },
  { category: "voice-over", name: "Voice Over" },
  { category: "web-development", name: "Web Development" },
  { category: "photography", name: "Photography" },
  { category: "business", name: "Business" },
  { category: "illustration", name: "Illustration" },
  { category: "seo", name: "SEO" },
  { category: "wordpress", name: "WordPress" },
];
